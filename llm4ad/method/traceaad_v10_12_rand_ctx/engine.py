"""TraceAAD V10.12 engine with random archive references instead of formation history."""

from ..traceaad_v10_12.selection import OPERATORS, OPERATOR_PROBABILITIES
from ..traceaad_v10_12.traceaad import REPAIRABLE_FAILURES, TraceAADV1012
from .context import RandomReferenceBuilder, rank_softmax_sample


class TraceAADV1012RandCtx(TraceAADV1012):
    """V10.12 search whose generation context swaps trajectory steps for archive cards.

    Selection, operators, repair, budget accounting and persistence follow V10.12
