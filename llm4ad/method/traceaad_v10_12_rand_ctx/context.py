"""Random archive-reference context for the V10.12 trajectory ablation."""

import math

from ..traceaad_v10_12.parsing import OUTPUT
from ..traceaad_v10_12.prompts import OPERATOR_INSTRUCTIONS, TrajectoryBuilder
