"""Lightweight live monitor for TraceAAD training runs.

The generic result reader and HTTP API live here; experiment packages only
provide compatibility entry points.
"""
...
class MonitorDataEngine:
    ...
    def get_overview(
        self, version: str | None = None, max_age_sec: float = 5.0
    ) -> dict[str, Any]:
