...
当前工作区是 **v10.13-r3**，设计见 [r3 机制定义](../../docs/01-主线版本/TraceAAD-V10.13-r3-机制设计.md)。2026-09-24已按用户授权停止 r2，保留原冻结运行时及全部结果；`20260924_v1013r3` 已按同配置启动20路。[切换与启动检查](../../docs/02-实验结果/2026-09-24-V10.13-r3简化与重启.md)保存证据。不要用 r3 恢复 r2 checkpoint。新批次创建前需确认没有同名结果和会话。
