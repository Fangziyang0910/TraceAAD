...
from pathlib import Path
import experiments.traceaad_v10_13.run as entry
...
def freeze(batch, prefix='v1013'):
    ...
    # Import closure of experiments.traceaad_v10_13.run only: retired method
    # packages and unrelated task families are deliberately not frozen.
    sources = [
        root / 'core',
        root / 'traceaad/v10_13',
        root / 'experiments/infra',
        root / 'experiments/traceaad_v10_13',
    ]
    ...
    (runtime / 'experiments/traceaad_v10_13/results').symlink_to(results, target_is_directory=True)
