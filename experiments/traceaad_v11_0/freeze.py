...
def freeze(batch, prefix='v110'):
    ...
    (runtime / 'experiments/traceaad_v11_0/results').symlink_to(results, target_is_directory=True)
    command = [sys.executable, '-m', 'experiments.traceaad_v11_0.launch', '--batch', batch,
